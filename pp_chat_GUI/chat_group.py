...
class Group:
    ...
    def connect(self, me, peer):
        peer_in_group = False
        me_in_group = False #can grab others into a group chat if you're already chatting
        #if peer is in a group, join it
        peer_in_group, group_key = self.find_group(peer)
        if peer_in_group == True and me in self.chat_grps[group_key]:
            pass
        elif peer_in_group == True:
